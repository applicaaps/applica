# Privacy Policy di applicaaps.com

Ultimo aggiornamento: 12 giugno 2026

## 1. Titolare del trattamento

Ai sensi dell'art. 13 del Regolamento (UE) 2016/679 ("GDPR"), Applica APS, con domicilio fiscale in Via Stazione 163, 70029 Santeramo in Colle (BA), sede operativa/di contatto in Via Roma 69, 70029 Santeramo in Colle (BA), email: applicapsicologia@gmail.com, codice fiscale: **91152320726**, in qualità di Titolare del trattamento, informa gli utenti in merito al trattamento dei dati personali effettuato tramite il sito web [applicaaps.com](https://applicaaps.com).
...
## 6. Servizi e fornitori coinvolti
...
- **Google Forms**, utilizzato per la raccolta delle candidature o richieste trasmesse tramite moduli esterni distinti per pazienti e psicologi [3][4];
- **Strapi**, utilizzato quale backend/CMS per la gestione dei contenuti e delle funzionalità del sito;
- **Supabase**, utilizzato per la gestione del database e, ove applicabile, dell'autenticazione o dei dati connessi all'area riservata.
...
## 7. Luogo del trattamento e trasferimento dei dati
...
## 10. Assenza di tracciamento pubblicitario
...
- **Sede operativa/contatti:** Via Roma 69, 70029 Santeramo in Colle (BA)
- **Email:** applicapsicologia@gmail.com
...
## Nota operativa prima della pubblicazione

Prima della pubblicazione definitiva è opportuno:

- verificare che i Google Forms contengano una informativa coerente con questa policy oppure un richiamo espresso alla presente informativa [3][4];
- verificare se sia necessario inserire anche una cookie policy separata, anche nel caso in cui il sito utilizzi esclusivamente cookie tecnici;
- verificare le condizioni contrattuali e i ruoli privacy di Strapi, Supabase e Google in relazione alle funzionalità effettivamente attive.